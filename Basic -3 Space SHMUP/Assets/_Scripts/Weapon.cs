...
/// It also includes a "sheild" type to allow a shield power-up
...
public class WeaponDefinition
{
    ...
    public string letter; // power up type 
    public Color color = Color.white; // color of powerup
...
public class Weapon : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //Dynamically create an anchor for all Projectile
